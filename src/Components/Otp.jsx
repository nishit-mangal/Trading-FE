...
export const Otp = ( {email, setResponseErr} ) =>{
    ...
    return (
        <div>
            {accountVerified && <div className='text-green-700 font-medium font-serif text-base mt-1 mb-4'>Account verified successfully. Login to proceed.</div>}
            <div className="text-2xl font-sans font-semibold">Enter OTP</div>
            <div className="text-xs font-serif text-gray-500">recieved on: <span className="font-bold text-teal-800">{email}</span></div>
            ...
            <div className='text-xs text-center mt-3'>
                ...
                <span className='ml-1 text-teal-700 font-bold hover:cursor-pointer font-sans' onClick={handleResendOTP}>
                    Resend
                </span> 
            </div>
        </div>
